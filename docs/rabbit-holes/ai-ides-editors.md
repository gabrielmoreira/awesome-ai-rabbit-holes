...
- **[code server](https://github.com/coder/code-server)** `⭐ 77.7k` `updated ≤30d` Run VS Code on any machine and access it through a browser-based interface, separating the editor from local hardware constraints. <details><summary>More about</summary>

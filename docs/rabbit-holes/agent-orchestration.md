...
- **[Agno](https://github.com/agno-agi/agno)** `⭐ 42.1k` `updated ≤30d` A framework and runtime for building, running, and managing scalable agent platforms with built-in memory, observability, and security. <details><summary>More about</summary>
...
- **[MaxKB](https://github.com/1panel-dev/maxkb)** `⭐ 22.8k` `updated ≤30d` An open-source platform for building enterprise-grade agents with integrated RAG pipelines and workflow orchestration. <details><summary>More about</summary>
...
- **[coze-studio](https://github.com/coze-dev/coze-studio)** `⭐ 21.6k` `updated ≤90d` An open-source AI agent development platform with visual tools for building, debugging, and deploying agents, workflows, and apps. <details><summary>More about</summary>
...
- **[github/gh-aw](https://github.com/github/gh-aw)** `⭐ 5.1k` `updated ≤30d` A GitHub CLI extension that converts Markdown-based agent definitions into executable GitHub Actions workflows. <details><summary>More about</summary>

  It allows developers to integrate autonomous agents for tasks like PR reviews and issue triage directly into their existing CI/CD pipelines.

  _Because your CI/CD pipeline shouldn't just break; it should now autonomously argue about why it broke._

  `github-actions` `agentic-workflows` `cli-extension` `automation`
  </details>
...
- **[AgentField](https://github.com/agent-field/agentfield)** `⭐ 2.6k` `updated ≤30d` An open-source control plane for building, running, and scaling AI agents as scalable microservices via APIs. <details><summary>More about</summary>
...
- **[Dust](https://github.com/dust-tt/dust)** `⭐ 1.5k` `updated ≤30d` Custom AI agent platform for building and deploying agents to speed up work. <details><summary>More about</summary>
...
- **[hcom](https://github.com/aannoo/hcom)** `⭐ 486` `updated ≤90d` A CLI tool that enables AI agents to communicate, observe, and spawn one another across different terminal sessions. <details><summary>More about</summary>
...
- **[ntm](https://github.com/dicklesworthstone/ntm)** `⭐ 444` `updated ≤30d` NTM is a Go-based TUI tool that orchestrates multiple AI coding agents across tmux panes with session labeling, work triage, safety approvals, and robot surfaces. <details><summary>More about</summary>
...
- **[Coasts](https://github.com/coast-guard/coasts)** `⭐ 426` `updated ≤180d` Localhost service isolation and orchestration for git worktrees, enabling multiple isolated development environments on a single machine. <details><summary>More about</summary>
...
- **[Dorothy](https://github.com/charlie85270/dorothy)** `⭐ 345` `updated ≤90d` Dorothy is a desktop app that orchestrates multiple AI coding agents (Claude Code, Codex, Gemini, Grok, local) via a unified UI with Kanban task management and scheduling. <details><summary>More about</summary>
...
- **[amux](https://github.com/andyrewlee/amux)** `⭐ 158` `updated ≤30d` A terminal UI for running multiple coding agents in parallel using a workspace-first model with git worktrees. <details><summary>More about</summary>
...
- **[alexgreensh/outsourcerer](https://github.com/alexgreensh/outsourcerer)** `⭐ 145` `updated ≤30d` A CLI tool that orchestrates multiple AI coding agents and models by delegating tasks to specialized or cheaper engines while preserving the user's environment. <details><summary>More about</summary>
...
- **[OMK](https://github.com/dmae97/omk)** `⭐ 143` `updated ≤30d` OMK is a CLI-based multi-agent control plane that scopes, routes, verifies, and replays coding agent tasks using bounded DAGs and evidence-gated workflows. <details><summary>More about</summary>
...
- **[quorum-cli](https://github.com/detrol/quorum-cli)** `⭐ 116` `updated ≤1y` A CLI tool for running structured multi-agent debates between LLMs (Claude, GPT, Gemini, Grok, Ollama) in the terminal. <details><summary>More about</summary>
...
- **[GNAP](https://github.com/farol-team/gnap)** `⭐ 81` `updated ≤1y` GNAP is a git-native protocol for coordinating AI agents using only git repositories as transport and storage. <details><summary>More about</summary>
...
- **[5dive](https://github.com/5dive-ai/5dive)** `⭐ 57` `updated ≤30d` 5dive is a self-hosted runtime for running multiple AI coding agents on a server, letting them collaborate via a shared task queue and org chart, with human escalation over Telegram. <details><summary>More about</summary>
...
- **[Crewplane](https://github.com/crewplaneai/crewplane)** `⭐ 38` `updated ≤30d` A workflow engine that orchestrates coding-agent CLIs (Claude Code, Codex, Copilot CLI, etc.) via Markdown-defined stages, with resumable, reviewable handoffs stored on disk. <details><summary>More about</summary>
...
- **[repomon](https://github.com/alihamzaazam/repomon)** `⭐ 19` `updated ≤30d` repomon is a Rust-based terminal UI that orchestrates multiple AI coding agents like Claude Code, Codex, Aider) across many repositories and AI coding agents in parallel via tmux-backed worktrees. <details><summary>More about</summary>
...
- **[danieldoderlein/llm-bus](https://github.com/danieldoderlein/llm-bus)** `⭐ 9` `updated ≤30d` Open-source coordination engine for AI agents using MCP to manage handoffs, shared ledgers, claims, leases, and presence without requiring git. <details><summary>More about</summary>
...
- **[dephelion/baya-cli](https://github.com/dephelion/baya-cli)** `⭐ 5` `updated ≤30d` A CLI tool that converts plain-text task lists into dependency graphs to execute coding tasks across multiple existing AI agent CLIs in parallel. <details><summary>More about</summary>

  It allows developers to automate complex, multi-step workflows by routing specific sub-tasks to the specific models or agents they already have authenticated.

  _You can now experience the existential dread of a failing task graph across four different monthly subscriptions simultaneously._

  `cli` `orchestration` `multi-agent` `workflow` `automation`
  </details>
...
- **[RailWarden](https://github.com/advaith-1212/railwarden)** `⭐ 2` `updated ≤90d` A deterministic control plane for coordinating multi-agent software development via isolated Git worktrees and mechanical validation gates. <details><summary>More about</summary>

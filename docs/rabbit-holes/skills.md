...
- **[skills](https://github.com/anthropics/skills)** `⭐ 129.1k` `updated ≤30d` A public repository from Anthropic containing reusable Agent Skills — self-contained folders with instructions, scripts, and resources that Claude dynamically loads to perform specialized tasks. <details><summary>More about</summary>
...
- **[ClawHub](https://github.com/openclaw/clawhub)** `⭐ 8.5k` `updated ≤30d` ClawHub is a public registry and CLI for publishing, versioning, searching, and installing text-based agent skills (SKILL.md) and OpenClaw plugins. <details><summary>More about</summary>
  ...
  _We have now successfully dockerized the concept of 'vibes' into versioned SKILL.md files with install counts and telemetry._
...
- **[llm-wiki-agent](https://github.com/samuraigpt/llm-wiki-agent)** `⭐ 2.5k` `updated ≤30d` A reusable skill pack that turns Claude Code, Codex, Gemini CLI, or OpenCode into a self-building personal wiki by ingesting documents and maintaining interlinked markdown pages with knowledge graphs. <details><summary>More about</summary>
  ...
  _We have reached the point where the agent needs its own agent to remember what the agent did with the documents you fed the agent so you do not have to write notes like a Victorian clerk._

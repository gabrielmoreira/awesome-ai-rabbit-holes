...
- **[MarkItDown](https://github.com/microsoft/markitdown)** `⭐ 166.4k` `updated ≤30d` Python tool for converting files and office documents to Markdown. <details><summary>More about</summary>
...
- **[LangChain](https://github.com/langchain-ai/langchain)** `⭐ 142.2k` `updated ≤30d` LangChain is a framework for building agents and LLM-powered applications with interoperable components and third-party integrations. <details><summary>More about</summary>
...
- **[TradingAgents](https://github.com/tauricresearch/tradingagents)** `⭐ 93.9k` `updated ≤30d` A multi-agent framework that coordinates LLM-powered roles—including researchers, analysts, and portfolio managers—to simulate and backtest financial trading strategies. <details><summary>More about</summary>
...
- **[MetaGPT](https://github.com/foundationagents/metagpt)** `⭐ 69.4k` `updated ≤1y` MetaGPT is an open-source multi-agent framework that assigns SOP-driven roles—such as product manager, architect, and engineer—to LLMs to turn a one-line requirement into structured software deliverables and repositories. <details><summary>More about</summary>
...
- **[Docling](https://github.com/docling-project/docling)** `⭐ 63.2k` `updated ≤30d` Docling is a document parsing library that converts PDF, DOCX, PPTX, HTML, and other formats into structured Markdown or JSON for AI workflows. <details><summary>More about</summary>
...
- **[AutoGen](https://github.com/microsoft/autogen)** `⭐ 59.8k` `updated ≤180d` AutoGen is a Microsoft-maintained framework for building multi-agent AI applications that can operate autonomously or collaborate with humans. <details><summary>More about</summary>
...
- **[CrewAI](https://github.com/crewaiinc/crewai)** `⭐ 55.8k` `updated ≤30d` Python framework for orchestrating role-playing, autonomous AI agents with collaborative intelligence. <details><summary>More about</summary>
...
- **[LiteLLM 🚅](https://github.com/berriai/litellm)** `⭐ 54.1k` `updated ≤30d` Open source AI gateway that provides a unified interface to call 100+ LLM providers using the OpenAI format, with cost tracking, guardrails, load balancing, and logging. <details><summary>More about</summary>
...
- **[LlamaIndex](https://github.com/run-llama/llama_index)** `⭐ 51k` `updated ≤30d` LlamaIndex is an open-source Python framework for building agentic applications with data connectors, retrieval pipelines, and integrations for LLMs, embeddings, and vector stores. <details><summary>More about</summary>
...
- **[LightRAG](https://github.com/hkuds/lightrag)** `⭐ 37.9k` `updated ≤30d` LightRAG is a research-backed framework for simple and fast retrieval-augmented generation (RAG) with knowledge graph support. <details><summary>More about</summary>
...
- **[LangGraph](https://github.com/langchain-ai/langgraph)** `⭐ 37.7k` `updated ≤30d` LangGraph is a low-level orchestration framework for building, managing, and deploying stateful, long-running AI agents as graphs in Python and TypeScript. <details><summary>More about</summary>
...
- **[DSPy](https://github.com/stanfordnlp/dspy)** `⭐ 36.3k` `updated ≤30d` DSPy is a Python framework for programming language models with composable code and algorithms that optimize prompts and model weights. <details><summary>More about</summary>
...
- **[CopilotKit](https://github.com/copilotkit/copilotkit)** `⭐ 36.2k` `updated ≤30d` An open-source SDK for building agent-native applications with generative UI, shared state, and human-in-the-loop workflows across React, Angular, and other platforms. <details><summary>More about</summary>
...
- **[GraphRAG](https://github.com/microsoft/graphrag)** `⭐ 34.5k` `updated ≤30d` A modular, graph-based Retrieval-Augmented Generation (RAG) system from Microsoft that extracts structured knowledge graphs from unstructured text using LLMs. <details><summary>More about</summary>
...
- **[Qdrant](https://github.com/qdrant/qdrant)** `⭐ 33.4k` `updated ≤30d` Qdrant is a high-performance vector database and similarity search engine built in Rust, designed for storing, searching, and managing vector embeddings with payload filtering. <details><summary>More about</summary>
...
- **[PyTorch Lightning](https://github.com/lightning-ai/pytorch-lightning)** `⭐ 31.2k` `updated ≤30d` PyTorch Lightning is a framework that automates PyTorch training engineering like backpropagation, mixed precision, and multi-GPU scaling while preserving full model control. <details><summary>More about</summary>
...
- **[Chroma](https://github.com/chroma-core/chroma)** `⭐ 28.8k` `updated ≤30d` Open-source vector database and search infrastructure for AI applications. <details><summary>More about</summary>
...
- **[ScrapeGraphAI](https://github.com/scrapegraphai/scrapegraph-ai)** `⭐ 28.5k` `updated ≤30d` A Python library that uses LLMs and graph logic to build scraping pipelines for websites and local documents based on natural language extraction instructions. <details><summary>More about</summary>
...
- **[Smolagents](https://github.com/huggingface/smolagents)** `⭐ 28.4k` `updated ≤30d` A barebones Python library for building agents that think in code, with first-class support for code agents and sandboxed execution. <details><summary>More about</summary>
...
- **[Semantic Kernel](https://github.com/microsoft/semantic-kernel)** `⭐ 28.3k` `updated ≤30d` Semantic Kernel is a model-agnostic SDK for building, orchestrating, and deploying AI agents and multi-agent systems. <details><summary>More about</summary>
...
- **[AgentScope](https://github.com/agentscope-ai/agentscope)** `⭐ 28k` `updated ≤30d` AgentScope is a production-ready multi-agent framework with built-in support for event systems, permission management, and sandboxed workspaces. <details><summary>More about</summary>
...
- **[deepagents](https://github.com/langchain-ai/deepagents)** `⭐ 26.3k` `updated ≤30d` An opinionated, batteries-included agent harness built on top of LangGraph and LangChain. <details><summary>More about</summary>
...
- **[Mastra](https://github.com/mastra-ai/mastra)** `⭐ 26.2k` `updated ≤30d` Mastra is a TypeScript framework for building AI-powered applications and agents, providing model routing, workflow orchestration, memory management, and built-in evals. <details><summary>More about</summary>
...
- **[LeRobot](https://github.com/huggingface/lerobot)** `⭐ 26k` `updated ≤30d` A Python-native library for end-to-end robotic learning, providing standardized datasets, hardware-agnostic control, and pretrained models. <details><summary>More about</summary>
...
- **[Haystack](https://github.com/deepset-ai/haystack)** `⭐ 25.9k` `updated ≤30d` Open-source AI orchestration framework for building production-ready LLM applications with modular pipelines and agent workflows. <details><summary>More about</summary>
...
- **[AI](https://github.com/vercel/ai)** `⭐ 25.7k` `updated ≤30d` The AI SDK is a provider-agnostic TypeScript toolkit for building AI-powered applications and agents using React, Next.js, and other UI frameworks. <details><summary>More about</summary>
...
- **[Dolt](https://github.com/dolthub/dolt)** `⭐ 23.9k` `updated ≤30d` Dolt is a SQL database with Git-like version control for tables, enabling fork, clone, branch, merge, push, and pull operations. <details><summary>More about</summary>
  ...
  _Now you can argue about merge conflicts in your database schema at 2 AM, just like with Git._

  `data-versioning` `sql` `git-for-data` `agent-memory`
  </details>

- **[veRL (`🔥`)](https://github.com/verl-project/verl)** `⭐ 22.6k` `updated ≤30d` A flexible, efficient RL post-training framework for large language models that implements algorithms like GRPO and PPO with seamless integration into existing LLM training infrastructure. <details><summary>More about</summary>
...
- **[RAG-Anything](https://github.com/hkuds/rag-anything)** `⭐ 22.3k` `updated ≤30d` RAG-Anything is an all-in-one RAG framework for multi-modal retrieval-augmented generation. <details><summary>More about</summary>
...
- **[Swarm](https://github.com/openai/swarm)** `⭐ 21.8k` `updated ≤180d` Swarm is an educational, lightweight multi-agent orchestration framework from OpenAI that demonstrates agent coordination and handoffs using only the Chat Completions API. <details><summary>More about</summary>
...
- **[PEFT](https://github.com/huggingface/peft)** `⭐ 21.4k` `updated ≤30d` PEFT is a Python library for state-of-the-art Parameter-Efficient Fine-Tuning methods like LoRA, enabling adaptation of large pre-trained models with minimal computational and storage costs. <details><summary>More about</summary>
...
- **[Candle](https://github.com/huggingface/candle)** `⭐ 20.7k` `updated ≤30d` Minimalist ML framework for Rust with GPU support and a focus on performance and ease of use. <details><summary>More about</summary>
...
- **[adk-python](https://github.com/google/adk-python)** `⭐ 20.6k` `updated ≤30d` An open-source, code-first Python framework for building, evaluating, and deploying AI agents. <details><summary>More about</summary>
...
- **[Cua](https://github.com/trycua/cua)** `⭐ 20.4k` `updated ≤30d` Open-source infrastructure providing sandboxes, SDKs, and benchmarks for training and deploying computer-use AI agents. <details><summary>More about</summary>
...
- **[PydanticAI](https://github.com/pydantic/pydantic-ai)** `⭐ 18.7k` `updated ≤30d` A Python agent framework from the Pydantic team for building production-grade GenAI applications with type-safe models, tool integration, and durable execution. <details><summary>More about</summary>
...
- **[LangChain.js](https://github.com/langchain-ai/langchainjs)** `⭐ 18k` `updated ≤30d` LangChain.js is a TypeScript/JavaScript framework for building LLM-powered applications with composable components and integrations. <details><summary>More about</summary>
...
- **[Qwen-Agent](https://github.com/qwenlm/qwen-agent)** `⭐ 16.8k` `updated ≤180d` Qwen-Agent is a Python framework for building LLM-powered applications using Qwen models, featuring function calling, MCP compatibility, RAG, and a code interpreter. <details><summary>More about</summary>
...
- **[Llmware](https://github.com/llmware-ai/llmware)** `⭐ 14.8k` `updated ≤90d` llmware is a Python framework for building enterprise RAG pipelines with local, quantized small language models and integrated document parsing, embedding, and query tooling. <details><summary>More about</summary>
...
- **[Outlines](https://github.com/dottxt-ai/outlines)** `⭐ 14.5k` `updated ≤30d` A Python library for enforcing structured outputs from LLMs via type hints, grammars, and constraints. <details><summary>More about</summary>
...
- **[TensorRT-LLM](https://github.com/nvidia/tensorrt-llm)** `⭐ 14.2k` `updated ≤30d` TensorRT LLM is a Python and C++ framework from NVIDIA for defining, optimizing, and serving Large Language Models with specialized kernels and efficient runtimes on NVIDIA GPUs. <details><summary>More about</summary>
...
- **[Pipecat](https://github.com/pipecat-ai/pipecat)** `⭐ 13.6k` `updated ≤30d` Pipecat is an open-source Python framework for building real-time voice and multimodal conversational AI agents with composable pipelines and pluggable AI services. <details><summary>More about</summary>
...
- **[LitGPT](https://github.com/lightning-ai/litgpt)** `⭐ 13.5k` `updated ≤30d` litgpt provides 20+ high-performance LLMs with recipes to pretrain, finetune, and deploy at scale. <details><summary>More about</summary>
...
- **[e2b](https://github.com/e2b-dev/e2b)** `⭐ 13k` `updated ≤30d` Open-source infrastructure for running AI-generated code in secure isolated cloud sandboxes via SDKs. <details><summary>More about</summary>
...
- **[Gateway](https://github.com/portkey-ai/gateway)** `⭐ 12.5k` `updated ≤90d` A fast, open-source AI gateway that routes requests to 1,600+ LLMs with built-in guardrails, load balancing, and fallbacks via a single API. <details><summary>More about</summary>
...
- **[Eino](https://github.com/cloudwego/eino)** `⭐ 12.4k` `updated ≤30d` Eino is a Go-based LLM application development framework with components, agent toolkits, and workflow orchestration. <details><summary>More about</summary>
...
- **[Chainlit](https://github.com/chainlit/chainlit)** `⭐ 12.3k` `updated ≤90d` Chainlit is a Python framework for building production-ready conversational AI applications with a built-in UI. <details><summary>More about</summary>
...
- **[Zerox](https://github.com/getomni-ai/zerox)** `⭐ 12.2k` `updated >1y` An OCR and document extraction tool that leverages vision models to convert complex documents into structured data. <details><summary>More about</summary>
...
- **[axolotl](https://github.com/axolotl-ai-cloud/axolotl)** `⭐ 12.2k` `updated ≤30d` An open-source framework designed for fine-tuning large language models. <details><summary>More about</summary>
...
- **[agent-framework](https://github.com/microsoft/agent-framework)** `⭐ 12.1k` `updated ≤30d` Microsoft Agent Framework is a multi-language SDK for building, orchestrating, and deploying production-grade AI agents and multi-agent workflows in Python and .NET. <details><summary>More about</summary>
...
- **[Tambo](https://github.com/tambo-ai/tambo)** `⭐ 11.2k` `updated ≤30d` An open-source React SDK and backend toolkit that lets developers register UI components with Zod schemas so an LLM agent can select and stream props to render generative user interfaces. <details><summary>More about</summary>
...
- **[ten-framework](https://github.com/ten-framework/ten-framework)** `⭐ 10.9k` `updated ≤30d` An open-source framework for building real-time, multimodal conversational AI agents with support for voice, video, and extensions like memory and turn detection. <details><summary>More about</summary>
...
- **[Kedro](https://github.com/kedro-org/kedro)** `⭐ 10.9k` `updated ≤30d` Kedro is a Python framework for building production-ready, reproducible, and modular data engineering and data science pipelines. <details><summary>More about</summary>
...
- **[tokenizers](https://github.com/huggingface/tokenizers)** `⭐ 10.9k` `updated ≤30d` Fast, Rust-based tokenizers library for research and production with bindings for Python, Node.js, and Ruby. <details><summary>More about</summary>
...
- **[instant](https://github.com/instantdb/instant)** `⭐ 10.4k` `updated ≤30d` Instant is a backend-as-a-service providing auth, permissions, storage, presence, and real-time streams for AI-coded apps. <details><summary>More about</summary>

  It eliminates the need to manually set up databases, caches, ORMs, and endpoints, letting developers focus on building UX with client-side queries and multiplayer sync.

  _Finally, a backend that lets you pretend the last 20 years of distributed systems papers never happened._

  `backend-as-a-service` `realtime-database` `multiplayer-sync` `ai-app-infra`
  </details>

- **[SkyPilot](https://github.com/skypilot-org/skypilot)** `⭐ 10.3k` `updated ≤30d` SkyPilot is a system for running, managing, and scaling AI workloads across diverse infrastructure including Kubernetes, Slurm, 20+ clouds, and on-prem environments. <details><summary>More about</summary>
...
- **[Metaflow](https://github.com/netflix/metaflow)** `⭐ 10.2k` `updated ≤30d` Metaflow is a Python framework for building and managing real-life AI/ML systems, from rapid local prototyping in notebooks to scalable production deployments on cloud infrastructure. <details><summary>More about</summary>
...
- **[Accelerate](https://github.com/huggingface/accelerate)** `⭐ 9.8k` `updated ≤30d` A PyTorch library that simplifies distributed training and mixed precision by abstracting boilerplate code for multi-GPU/TPU/fp16 setups. <details><summary>More about</summary>
...
- **[Langchain Go](https://github.com/tmc/langchaingo)** `⭐ 9.6k` `updated ≤1y` LangChain for Go is a Go-native library providing composable building blocks for writing LLM-powered applications, including model abstraction, chains, and memory. <details><summary>More about</summary>
...
- **[Oumi](https://github.com/oumi-ai/oumi)** `⭐ 9.4k` `updated ≤30d` A code-first, open-source framework and CLI for fine-tuning, evaluating, and deploying open-source LLMs and VLMs across local and cloud environments. <details><summary>More about</summary>
...
- **[deeplake](https://github.com/activeloopai/deeplake)** `⭐ 9.2k` `updated ≤90d` Deeplake is a serverless multimodal datalake designed for storing, searching, and streaming AI datasets including images, video, and audio. <details><summary>More about</summary>
...
- **[KAG](https://github.com/openspg/kag)** `⭐ 8.9k` `updated ≤180d` KAG is a knowledge-augmented generation framework that combines the OpenSPG engine and LLMs to provide logical reasoning and multi-hop Q&A for professional domain knowledge bases, moving beyond traditional vector similarity RAG. <details><summary>More about</summary>
...
- **[BentoML](https://github.com/bentoml/bentoml)** `⭐ 8.7k` `updated ≤30d` BentoML is a Python framework for building and serving AI model inference APIs, job queues, and multi-model pipelines. <details><summary>More about</summary>
...
- **[TypeChat](https://github.com/microsoft/typechat)** `⭐ 8.7k` `updated ≤30d` TypeChat is a library that makes it easy to build natural language interfaces using types. <details><summary>More about</summary>

  It replaces prompt engineering with schema engineering, letting developers define intents as types and get structured, validated LLM responses for natural language interfaces.

  _Another layer of type safety to wrestle with when all you wanted was for the AI to just understand 'make it work'._

  `nlu` `type-safety` `llm-interface`
  </details>

- **[PraisonAI](https://github.com/mervinpraison/praisonai)** `⭐ 8.5k` `updated ≤30d` PraisonAI is an AI agent framework for building autonomous multi-agent systems that can research, plan, code, and execute tasks with built-in memory and RAG. <details><summary>More about</summary>
...
- **[Flyte](https://github.com/flyteorg/flyte)** `⭐ 7.1k` `updated ≤30d` A Python-based orchestration engine for reliably running ML pipelines, models, and agents at scale. <details><summary>More about</summary>
...
- **[Swarms](https://github.com/kyegomez/swarms)** `⭐ 7k` `updated ≤30d` An enterprise-grade multi-agent orchestration framework for coordinating AI agents in production workflows. <details><summary>More about</summary>
...
- **[Bifrost](https://github.com/maximhq/bifrost)** `⭐ 6.5k` `updated ≤30d` Bifrost is a high-performance AI gateway that unifies access to multiple LLM providers through an OpenAI-compatible API with load balancing, failover, and guardrails. <details><summary>More about</summary>
...
- **[genkit](https://github.com/genkit-ai/genkit)** `⭐ 6.2k` `updated ≤30d` An open-source framework for building full-stack AI-powered applications in JavaScript, Go, and Python. <details><summary>More about</summary>

  It provides a unified SDK to integrate various LLM providers and handles complex tasks like structured output, tool calling, and RAG workflows.

  _It promises a 'unified interface' for an ecosystem that changes its preferred SDKs every Tuesday._

  `frameworks` `sdk` `llm-orchestration` `rag` `typescript`
  </details>

- **[Marvin](https://github.com/prefecthq/marvin)** `⭐ 6.2k` `updated ≤30d` Marvin is a Python framework for producing structured LLM outputs and building agentic workflows via tasks, specialized agents, and thread-based orchestration. <details><summary>More about</summary>
...
- **[Agents](https://github.com/aiwaves-cn/agents)** `⭐ 5.9k` `updated >1y` An open-source framework for building self-evolving autonomous language agents using symbolic learning. <details><summary>More about</summary>

  It introduces a method for agents to learn from their own execution trajectories by applying gradient-based updates to their symbolic components.

  _It's one more way to pretend we can mathematically optimize the chaotic reasoning of a prompt-based agent._

  `autonomous-agents` `symbolic-learning` `agent-framework` `self-evolving` `llm`
  </details>

- **[torchtune](https://github.com/meta-pytorch/torchtune)** `⭐ 5.8k` `updated ≤30d` PyTorch native post-training library for large language model fine-tuning. <details><summary>More about</summary>
...
- **[Kserve](https://github.com/kserve/kserve)** `⭐ 5.7k` `updated ≤30d` Standardized distributed generative and predictive AI inference platform for scalable, multi-framework deployment on Kubernetes. <details><summary>More about</summary>
...
- **[SandBox](https://github.com/agent-infra/sandbox)** `⭐ 5.4k` `updated ≤30d` An all-in-one sandbox environment for AI agents that provides a single Docker container with a browser, shell, filesystem, VSCode server, and MCP support. <details><summary>More about</summary>
...
- **[Sparrow](https://github.com/katanaml/sparrow)** `⭐ 5.2k` `updated ≤30d` A framework for structured data extraction, instruction calling, and agentic workflows using ML, LLM, and Vision LLM models. <details><summary>More about</summary>

  It enables developers to build pipelines that extract and process structured data from documents or visual inputs, automating workflows that typically require manual intervention.

  _Now you can finally offload the soul-crushing task of parsing PDFs to an agent that might still hallucinate the table headers._

  `data-extraction` `agentic-workflows` `vision-llm` `document-ai` `huggingface`
  </details>
...
- **[Solace Agent Mesh](https://github.com/solacelabs/solace-agent-mesh)** `⭐ 5k` `updated ≤30d` An event-driven Python framework for building multi-agent AI systems that communicate via the Solace event mesh and coordinate complex, multi-step workflows. <details><summary>More about</summary>
...
- **[text-embeddings-inference](https://github.com/huggingface/text-embeddings-inference)** `⭐ 4.9k` `updated ≤30d` A high-performance inference solution for deploying and serving open-source text embedding and sequence classification models. <details><summary>More about</summary>
...
- **[Infinity](https://github.com/infiniflow/infinity)** `⭐ 4.6k` `updated ≤30d` An AI-native database built for LLM applications, offering hybrid search across dense vectors, sparse vectors, tensors, and full-text. <details><summary>More about</summary>
...
- **[ExLlamaV2](https://github.com/turboderp-org/exllamav2)** `⭐ 4.6k` `updated ≤180d` ExLlamaV2 is a fast inference library for running LLMs locally on modern consumer GPUs. <details><summary>More about</summary>
...
- **[agency-swarm](https://github.com/vrsen/agency-swarm)** `⭐ 4.5k` `updated ≤30d` A Python framework for building multi-agent applications that extends the OpenAI Agents SDK with customizable agent roles, type-safe tools, and structured inter-agent communication flows. <details><summary>More about</summary>
...
- **[LMQL](https://github.com/eth-sri/lmql)** `⭐ 4.2k` `updated >1y` A programming language for large language models that combines traditional algorithmic logic with natural language prompting. <details><summary>More about</summary>

  It allows developers to use structured constraints and standard programming logic to control LLM outputs and reasoning processes.

  _Because apparently, standard Python was not enough of a headache, now we have to learn a new way to write 'if' statements for hallucinations._

  `llm-programming` `constrained-generation` `python-superset` `llm-logic`
  </details>

- **[adalflow](https://github.com/sylphai-inc/adalflow)** `⭐ 4.2k` `updated ≤90d` AdalFlow is a PyTorch-like Python library for building and auto-optimizing LLM workflows, including RAG pipelines, chatbots, and agents. <details><summary>More about</summary>
...
- **[optillm](https://github.com/algorithmicsuperintelligence/optillm)** `⭐ 4.2k` `updated ≤30d` An optimizing inference proxy for LLMs that improves performance and cost-efficiency. <details><summary>More about</summary>
...
- **[Langroid](https://github.com/langroid/langroid)** `⭐ 4.1k` `updated ≤30d` Langroid is a Python framework for building LLM-powered applications using multi-agent collaboration. <details><summary>More about</summary>
...
- **[LazyLLM](https://github.com/lazyagi/lazyllm)** `⭐ 3.9k` `updated ≤30d` LazyLLM is a low-code Python framework and development tool for building, deploying, and iterating on multi-agent LLM applications with support for fine-tuning and cross-platform infrastructure. <details><summary>More about</summary>
...
- **[Fast-GraphRAG](https://github.com/circlemind-ai/fast-graphrag)** `⭐ 3.8k` `updated ≤1y` A GraphRAG implementation that intelligently adapts to specific use cases, data, and queries. <details><summary>More about</summary>
...
- **[DataTrove](https://github.com/huggingface/datatrove)** `⭐ 3.2k` `updated ≤30d` A platform-agnostic library providing customizable pipeline processing blocks for data processing. <details><summary>More about</summary>
...
- **[claw0](https://github.com/shareai-lab/claw0)** `⭐ 3.2k` `updated ≤30d` A 10-section, 7,000-line Python tutorial that builds a production-grade AI agent gateway from scratch, starting with a basic while loop and progressing through tool use, sessions, routing, and concurrency. <details><summary>More about</summary>
...
- **[EvoAgentX](https://github.com/evoagentx/evoagentx)** `⭐ 3.1k` `updated ≤30d` An open-source framework for building, evaluating, and evolving modular, self-optimizing multi-agent systems. <details><summary>More about</summary>
...
- **[core](https://github.com/cheshire-cat-ai/core)** `⭐ 3.1k` `updated ≤30d` Cheshire Cat AI is a framework for building custom AI agents as microservices with API-first design, plugin extensibility, and built-in RAG. <details><summary>More about</summary>

  It lets developers deploy conversational AI agents with REST/WebSocket APIs, multiuser support, and plugin-based customization without locking into a specific LLM provider.

  _Finally, a way to turn your cat into a microservice—because regular microservices weren’t confusing enough._

  `agent-framework` `mcp` `rag` `docker` `plugin-system`
  </details>
...
- **[Griptape](https://github.com/griptape-ai/griptape)** `⭐ 2.6k` `updated ≤30d` Modular Python framework for building AI agents and workflows with chain-of-thought reasoning, tools, and memory. <details><summary>More about</summary>

  Developers can use it to create structured, reusable AI workflows with built-in components for RAG, memory, and multi-agent orchestration.

  _Finally, a framework that lets you build agents so you can spend less time building agents._

  `python` `agent-framework` `workflows` `rag` `memory`
  </details>
...
- **[nextpy](https://github.com/dot-agent/nextpy)** `⭐ 2.3k` `updated >1y` Nextpy is a Python framework for building self-modifying AI agents with a focus on prompt engineering, session state management, and optimized code generation. <details><summary>More about</summary>
  ...
  It offers developers fine-grained control over LLM outputs through structured prompts, guardrails, and performance optimizations like speculative sampling and KV cache reuse.
...
- **[agentUniverse](https://github.com/agentuniverse-ai/agentuniverse)** `⭐ 2.3k` `updated ≤30d` A multi-agent framework designed for building complex, domain-expert applications through collaborative patterns. <details><summary>More about</summary>
...
- **[Lagent](https://github.com/internlm/lagent)** `⭐ 2.3k` `updated ≤30d` A lightweight Python framework for building LLM-based agents with a modular, layer-like design inspired by PyTorch. <details><summary>More about</summary>
...
- **[envd](https://github.com/tensorchord/envd)** `⭐ 2.2k` `updated ≤30d` envd is a CLI tool that uses a Python-like DSL to define and provision container-based development environments for AI/ML workflows, supporting both local and Kubernetes execution. <details><summary>More about</summary>
...
- **[VeOmni](https://github.com/bytedance-seed/veomni)** `⭐ 2.1k` `updated ≤30d` A modular framework for scaling single- and multi-modal model pre-training and post-training across various accelerators. <details><summary>More about</summary>
...
- **[OxyGent](https://github.com/jd-opensource/oxygent)** `⭐ 2k` `updated ≤30d` OxyGent is an open-source Python framework for building modular, observable, and evolvable multi-agent systems using standardized Oxy components. <details><summary>More about</summary>
...
- **[AgentFlow](https://github.com/lupantech/agentflow)** `⭐ 2k` `updated ≤180d` AgentFlow is a trainable, modular agentic framework with Planner, Executor, Verifier, and Generator modules optimized via Flow-GRPO for tool-augmented reasoning. <details><summary>More about</summary>
...
- **[Smol Vision](https://github.com/merveenoyan/smol-vision)** `⭐ 2k` `updated ≤90d` Recipes for shrinking, optimizing, customizing cutting edge vision models. <details><summary>More about</summary>
...
- **[DemoGPT](https://github.com/melih-unsal/demogpt)** `⭐ 1.9k` `updated ≤180d` A Python toolkit and Streamlit app for quickly generating LangChain agent pipelines, tools, and RAG setups from prompts. <details><summary>More about</summary>
...
- **[Autochain](https://github.com/forethought-technologies/autochain)** `⭐ 1.9k` `updated ≤1y` AutoChain is a lightweight, extensible framework for building LLM agents with custom tools and automated evaluation. <details><summary>More about</summary>

  It lets developers rapidly prototype generative agents by reducing abstraction layers and providing built-in testing for multi-turn conversations.

  _Another agent framework promising simplicity, as if the real problem wasn't chaining together ten different LLMs, tools, and evals just to get a poem about AI._
...
- **[ContextGem](https://github.com/shcherbak-ai/contextgem)** `⭐ 1.9k` `updated ≤90d` ContextGem is an open-source Python framework that uses LLMs to extract structured data, insights, and justifications from documents with granular source references. <details><summary>More about</summary>
...
- **[VectorChord](https://github.com/supervc-stack/vectorchord)** `⭐ 1.7k` `updated ≤30d` VectorChord is a PostgreSQL extension for scalable, high-performance, and disk-efficient vector search, designed as the successor to pgvecto.rs. <details><summary>More about</summary>
...
- **[MLRun](https://github.com/mlrun/mlrun)** `⭐ 1.7k` `updated ≤30d` MLRun is an open-source MLOps platform for building, deploying, and managing continuous (gen) AI and ML applications across their lifecycle, integrating with development and CI/CD environments. <details><summary>More about</summary>
...
- **[Adala](https://github.com/humansignal/adala)** `⭐ 1.6k` `updated ≤30d` Adala is an autonomous data labeling agent framework for building and deploying specialized data processing agents. <details><summary>More about</summary>

  It lets developers create autonomous agents that iteratively learn skills for data labeling and processing tasks, grounded in provided datasets.

  _Now you can outsource your labeling tasks to agents that learn from your data, because nothing says 'trust' like an AI that trains itself on your ground truth._

  `agent-framework` `data-labeling` `autonomous-agents` `python` `llm`
  </details>
...
- **[ThinkGPT](https://github.com/jina-ai/thinkgpt)** `⭐ 1.6k` `updated >1y` ThinkGPT is a Python library implementing Chain of Thought techniques for LLMs, enabling memory, self-refinement, knowledge compression, and reasoning primitives. <details><summary>More about</summary>

  It helps developers augment LLMs with higher-order reasoning, long-term memory, and context-aware decision-making for code and knowledge-intensive tasks.

  _Because nothing says 'production-ready' like an LLM that remembers your entire codebase but still can't fix its own indentation errors._

  `chain-of-thought` `llm-reasoning` `python-library` `memory` `context-compression`
  </details>

- **[Mirascope](https://github.com/mirascope/mirascope)** `⭐ 1.5k` `updated ≤30d` Mirascope is a Python and TypeScript library that provides a unified, decorator-based interface for calling multiple frontier LLMs and building structured-output agents with tool use. <details><summary>More about</summary>
...
- **[Agentic Commerce Protocol](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol)** `⭐ 1.5k` `updated ≤30d` Agentic Commerce Protocol (ACP) is a versioned open standard from OpenAI and Stripe that ships OpenAPI specs, JSON Schemas, examples, and governance docs for letting AI agents complete real commerce and checkout flows. <details><summary>More about</summary>
...
- **[xLLM](https://github.com/xllm-ai/xllm)** `⭐ 1.5k` `updated ≤30d` A high-performance inference engine for LLM, VLM, DiT, and REC models optimized for diverse AI accelerators, hosted under the OpenAtom Foundation. <details><summary>More about</summary>
...
- **[Agent Protocol](https://github.com/agi-inc/agent-protocol)** `⭐ 1.5k` `updated >1y` An API specification and SDK that provides a common interface for interacting with AI agents regardless of their underlying tech stack. <details><summary>More about</summary>

  It aims to solve the fragmentation of agent interfaces, allowing developers to build compatible tools and benchmarks that work across different agent frameworks.

  _Another layer of abstraction to prevent the inevitable chaos of a thousand incompatible agent APIs._

  `agent-protocol` `api-spec` `interoperability` `agent-sdk` `openapi`
  </details>

- **[Loop GPT](https://github.com/farizrahman4u/loopgpt)** `⭐ 1.5k` `updated ≤30d` A modular Python framework for implementing Auto-GPT-style autonomous agents. <details><summary>More about</summary>

  It provides a programmatic, 'Pythonic' alternative to CLI-only agent tools, allowing developers to build highly extensible autonomous workflows with state serialization.

  _It gives you the perfect framework to build an agent that can spend your entire API budget in an infinite, serialized loop._

  `agent-framework` `python` `autonomous-agents` `gpt-4` `modular-ai`
  </details>
...
- **[AgentQL](https://github.com/tinyfish-io/agentql)** `⭐ 1.4k` `updated ≤30d` AgentQL is a suite of tools for connecting AI agents and LLMs to the web, featuring a natural language query language, Python and JavaScript SDKs, Playwright integrations, a REST API, and a browser debugger for extracting data and automating workflows on live sites. <details><summary>More about</summary>
...
- **[Chidori](https://github.com/thousandbirdsinc/chidori)** `⭐ 1.4k` `updated ≤30d` A Rust-based reactive runtime for building durable AI agents using deterministic Starlark scripts with built-in checkpointing, replay, and HTTP server capabilities. <details><summary>More about</summary>
...
- **[Parallax](https://github.com/gradienthq/parallax)** `⭐ 1.4k` `updated ≤30d` Parallax is a distributed model serving framework for building AI clusters across heterogeneous nodes. <details><summary>More about</summary>
...
- **[Langchain-rust](https://github.com/abraxas-365/langchain-rust)** `⭐ 1.3k` `updated ≤30d` A Rust implementation of the LangChain framework for building LLM-based applications. <details><summary>More about</summary>

  It enables developers to build composable, high-performance AI workflows using Rust's safety and concurrency guarantees.

  _Because apparently, Python wasn't slow enough for your production-grade LLM orchestration._

  `rust` `llm` `langchain` `orchestration` `sdk`
  </details>
...
- **[RAGLite](https://github.com/superlinear-ai/raglite)** `⭐ 1.2k` `updated ≤30d` RAGLite is a Python toolkit for building Retrieval-Augmented Generation pipelines with configurable LLMs, DuckDB or PostgreSQL backends, and advanced chunking, reranking, and hybrid search capabilities. <details><summary>More about</summary>
...
- **[AI.JSX](https://github.com/fixie-ai/ai-jsx)** `⭐ 1.1k` `updated >1y` An AI application framework for Javascript that enables LLMs to render React components dynamically. <details><summary>More about</summary>

  It allows developers to bridge the gap between text-based LLM responses and interactive, structured user interfaces using a componentized JSX syntax.

  _Because clearly, what the world needed was a way to turn prompt engineering into a React reconciliation problem._

  `react` `generative-ui` `javascript` `llm-framework` `jsx`
  </details>

- **[axflow](https://github.com/axflow/axflow)** `⭐ 1.1k` `updated >1y` A TypeScript framework designed for building robust, modular natural language applications. <details><summary>More about</summary>

  It provides a code-first, modular approach to AI development, including integrated tools for model abstraction, data generation, and evaluation.

  _Because choosing between a single monolithic SDK or a collection of modular micro-packages is exactly how you spend your Friday afternoons now._

  `typescript` `llm-framework` `ai-sdk` `modular-ai`
  </details>

- **[LLM Agents](https://github.com/mpaepper/llm_agents)** `⭐ 1.1k` `updated >1y` A minimal Python library for building LLM-controlled agents with custom tools like Python REPL, Google Search, and Hacker News search, inspired by LangChain. <details><summary>More about</summary>
...
- **[python-a2a](https://github.com/themanojdesai/python-a2a)** `⭐ 1k` `updated ≤1y` python-a2a is a Python library for implementing Google's Agent-to-Agent (A2A) protocol with Model Context Protocol (MCP) integration for building interoperable multi-agent systems. <details><summary>More about</summary>
...
- **[codeql-cli-binaries](https://github.com/github/codeql-cli-binaries)** `⭐ 989` `updated ≤30d` Binaries for the CodeQL CLI, a static analysis tool for querying codebases as data. <details><summary>More about</summary>
...
- **[Kaito](https://github.com/kaito-project/kaito)** `⭐ 985` `updated ≤30d` Kubernetes AI Toolchain Operator that automates LLM model inference, fine-tuning, and RAG engine deployment in Kubernetes clusters. <details><summary>More about</summary>
...
- **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** `⭐ 985` `updated ≤30d` pydantic-deepagents is a Python framework for building deep agent teams with tool calling, sandboxed execution, and multi-agent collaboration using Pydantic AI. <details><summary>More about</summary>
...
- **[LLM-Dojo 开源大模型学习场所，使用简洁且易阅读的代码构建模型训练框架](https://github.com/mst272/llm-dojo)** `⭐ 937` `updated ≤180d` A lightweight, code-first post-training framework for LLMs supporting SFT, RLVR, and various knowledge distillation techniques built on top of OpenRLHF. <details><summary>More about</summary>
...
- **[Agentarium](https://github.com/thytu/agentarium)** `⭐ 934` `updated ≤30d` Agentarium is a Python framework for creating, managing, and orchestrating multiple AI agents that can interact, maintain memory, and autonomously act within simulated environments. <details><summary>More about</summary>
...
- **[AgentForge](https://github.com/databassgit/agentforge)** `⭐ 829` `updated ≤30d` AgentForge is a low-code Python framework for building, testing, and orchestrating AI-powered autonomous agents and multi-agent systems. <details><summary>More about</summary>
  ...
  _Finally, a way to build agents that can argue with each other in YAML._
...
- **[microagents](https://github.com/aymenfurter/microagents)** `⭐ 824` `updated >1y` An experimental Python framework for dynamically creating self-improving agents that can self-edit their prompts and code. <details><summary>More about</summary>
  ...
  _Now you can spend hours debugging agents that debug themselves, because why stop at one layer of abstraction._

  `agent-framework` `self-improving-agents` `python` `gpt-4` `dynamic-agent-generation`
  </details>

- **[data-to-paper](https://github.com/technion-kishony-lab/data-to-paper)** `⭐ 811` `updated >1y` An automation framework that navigates interacting AI agents through end-to-end scientific research, from raw data analysis to generating human-verifiable, backward-traceable research papers. <details><summary>More about</summary>
...
- **[LMMs-Engine](https://github.com/evolvinglmms-lab/lmms-engine)** `⭐ 803` `updated ≤30d` A unified training engine designed for scaling multimodal model development. <details><summary>More about</summary>
...
- **[BambooAI](https://github.com/pgalko/bambooai)** `⭐ 784` `updated ≤90d` BambooAI is a Python library that enables natural language-driven data analysis by generating and executing code against local datasets, external APIs, and vector databases. <details><summary>More about</summary>
...
- **[CodeFuse-muAgent](https://github.com/codefuse-ai/codefuse-muagent)** `⭐ 774` `updated >1y` An open-source agent framework driven by an eventic knowledge graph that provides a Python SDK and a containerized runtime for building multi-agent workflows. <details><summary>More about</summary>
...
- **[Fructose](https://github.com/bananaml/fructose)** `⭐ 748` `updated >1y` Fructose is a Python package that turns type-annotated functions into strongly-typed LLM calls via an `@ai` decorator. <details><summary>More about</summary>
  ...
  _Finally, a way to pretend your LLM is just a very expensive function call._

  `python` `llm-wrapper` `type-annotations` `function-calling`
  </details>
...
- **[FEDOT](https://github.com/aimclub/fedot)** `⭐ 708` `updated ≤30d` An open-source AutoML framework for the automated design and optimization of machine learning pipelines. <details><summary>More about</summary>
...
- **[Pipelex](https://github.com/pipelex/pipelex)** `⭐ 692` `updated ≤30d` A declarative DSL and CLI for defining typed, reusable AI procedures (methods) that handle model routing, structured outputs, and pipeline orchestration across 60+ models. <details><summary>More about</summary>
...
- **[LangChainDart](https://github.com/davidmigloz/langchain_dart)** `⭐ 685` `updated ≤30d` Dart/Flutter port of the LangChain framework for building LLM-powered applications. <details><summary>More about</summary>

  Enables Dart/Flutter developers to integrate and chain LLM components (providers, retrieval, agents) without leaving their ecosystem.

  _Now Flutter devs can also spend their weekends debugging prompt templates instead of just widgets._
...
- **[LLama Cpp Agent](https://github.com/maximilian-winter/llama-cpp-agent)** `⭐ 651` `updated ≤180d` A Python framework for structuring interactions with local LLMs via llama.cpp, adding guided sampling for function calling and structured output. <details><summary>More about</summary>
...
- **[VectorDB](https://github.com/jina-ai/vectordb)** `⭐ 650` `updated >1y` A Python vector database offering CRUD operations, scalability options, and deployability from local to cloud environments. <details><summary>More about</summary>
...
- **[Swarm](https://github.com/christopherkarani/swarm)** `⭐ 554` `updated ≤30d` A Swift framework for building stateful AI agent workflows natively on Apple and Linux platforms. <details><summary>More about</summary>
...
- **[a2a-x402](https://github.com/google-agentic-commerce/a2a-x402)** `⭐ 538` `updated ≤30d` The A2A x402 Extension adds cryptocurrency payments to the Agent-to-Agent (A2A) protocol, enabling on-chain monetization for agent services. <details><summary>More about</summary>

  It allows developers to build agents that can charge for services like API calls or AI inference, creating a monetizable agent ecosystem.

  _Now your agents can send each other invoices in the form of HTTP 402 errors, because nothing says 'decentralized' like a payment-required loop._
...
- **[Agency](https://github.com/neurocult/agency)** `⭐ 512` `updated >1y` A Go-native library for building generative AI applications and autonomous agents using an idiomatic, provider-agnostic approach. <details><summary>More about</summary>
...
- **[ReLLM](https://github.com/r2d4/rellm)** `⭐ 512` `updated >1y` A Python library that constrains LLM token generation in real-time using regular expressions to enforce exact output structure. <details><summary>More about</summary>
...
- **[Eidolon](https://github.com/eidolon-ai/eidolon)** `⭐ 494` `updated ≤90d` Eidolon is an open-source pluggable Agent SDK and deployment server for building and deploying agent-based services. <details><summary>More about</summary>
  ...
  _Finally, a way to deploy agents as services—because nothing says 'production-ready' like turning your AI into a microservice._

  `agent-sdk` `deployment-server` `modular-agents` `python` `open-source`
  </details>

- **[Archai](https://github.com/microsoft/archai)** `⭐ 485` `updated ≤1y` Archai is a modular framework for Neural Architecture Search that accelerates efficient deep network generation through reproducible research. <details><summary>More about</summary>

  It automates the discovery of optimal neural architectures for developers building efficient deep learning models across NLP and vision tasks.

  _Finally, a tool that promises to automate the hyperparameter hell of NAS while you wait for it to finish searching over thousands of architectures._
...
- **[flyto-core](https://github.com/flytohub/flyto-core)** `⭐ 453` `updated ≤30d` An open-source execution kernel for automating AI-agent workflows via YAML recipes, MCP-native transport, and debuggable step-by-step replay. <details><summary>More about</summary>
  ...
  _Now you can finally watch your automation fail in high-definition, step-by-step, with per-step timing and screenshots._

  `automation` `mcp` `workflow-engine` `browser-automation` `python`
  </details>

- **[openapi](https://github.com/longbridge/openapi)** `⭐ 447` `updated ≤30d` Longbridge OpenAPI SDK provides multi-language (Rust, Python, Node.js, Java, C, C++) bindings and an MCP server implementation for programmatic trading, quotes, and portfolio data on the Longbridge platform. <details><summary>More about</summary>
...
- **[MindSQL](https://github.com/mindinventory/mindsql)** `⭐ 445` `updated >1y` MindSQL is a Python RAG library that translates natural language questions into SQL queries against PostgreSQL, MySQL, SQLite, Snowflake, and BigQuery using LLMs like GPT-4 and Llama 2. <details><summary>More about</summary>
...
- **[LangStream](https://github.com/langstream/langstream)** `⭐ 428` `updated >1y` LangStream is an event-driven developer platform for building and running LLM AI applications on Kubernetes and Kafka. <details><summary>More about</summary>

  It lets developers deploy AI apps as event-driven services using familiar cloud-native infrastructure instead of glue code.

  _Finally, a way to feel like you're doing real platform engineering while your LLM app still hallucinates in production._
...
- **[mcpadapt](https://github.com/grll/mcpadapt)** `⭐ 421` `updated ≤1y` A library that adapts MCP servers into tools for agentic frameworks like LangChain, CrewAI, and Smolagents. <details><summary>More about</summary>

  It bridges the gap between the 650+ existing MCP servers and popular agent frameworks, letting developers integrate MCP tools into their workflows without reinventing the wheel.

  _Now you can finally use that one MCP server someone wrote for their niche use case in your LangChain agent, because why should consistency stand in the way of progress._

  `mcp` `agent-frameworks` `integration` `python` `adapters`
  </details>
...
- **[Rigging](https://github.com/dreadnode/rigging)** `⭐ 416` `updated ≤30d` Lightweight LLM interaction framework for building production-ready AI workflows in Python. <details><summary>More about</summary>
...
- **[LLM Strategy](https://github.com/blackhc/llm-strategy)** `⭐ 399` `updated >1y` A Python library that implements the Strategy Pattern using LLMs by dynamically generating implementations for abstract methods via strongly-typed functions, dataclasses, and interfaces. <details><summary>More about</summary>

  It lets developers delegate interface implementations to LLMs while preserving type safety and structured data handling, reducing boilerplate for dynamic behavior.

  _Now you can argue with your LLM about whether it correctly implemented your abstract base class._

  `python` `llm-integration` `strategy-pattern` `type-safety` `code-generation`
  </details>
...
- **[AgentRun](https://github.com/tjmlabs/agentrun)** `⭐ 373` `updated ≤30d` A Python library and REST API that safely executes LLM-generated Python code inside isolated Docker containers with resource limits, dependency management, and safety checks. <details><summary>More about</summary>
...
- **[rs-graph-llm](https://github.com/a-agmon/rs-graph-llm)** `⭐ 351` `updated ≤30d` A high-performance, type-safe Rust framework for building stateful, interactive agentic workflows and multi-agent systems. <details><summary>More about</summary>
...
- **[Llama-github](https://github.com/jetxu-llm/llama-github)** `⭐ 291` `updated ≤30d` llama-github is a Python library that enables LLM chatbots, AI agents, and auto-dev solutions to perform Agentic RAG by retrieving relevant code snippets, issues, and repository information from GitHub. <details><summary>More about</summary>
...
- **[saplings](https://github.com/shobrook/saplings)** `⭐ 275` `updated ≤1y` A Python framework that adds Monte Carlo Tree Search, A*, and greedy best-first search algorithms to LLM agents with two lines of code. <details><summary>More about</summary>
...
- **[QABot](https://github.com/hardbyte/qabot)** `⭐ 245` `updated >1y` CLI tool for natural language queries on local or remote data files using LLMs and DuckDB. <details><summary>More about</summary>

  Lets developers ask ad-hoc analytical questions against CSV, Parquet, SQLite, Excel, or S3 data without writing SQL or code.

  _Finally, a way to offload your 'quick data questions' to an LLM that will definitely write better SQL than you._

  `cli` `data-query` `duckdb` `llm` `analytics`
  </details>

- **[Langchain Decorators](https://github.com/ju-bezdek/langchain-decorators)** `⭐ 234` `updated ≤180d` A lightweight Python decorator library that adds syntactic sugar for writing LangChain prompts and chains. <details><summary>More about</summary>

  It simplifies prompt and chain authoring in LangChain by leveraging Python decorators and docstrings for cleaner, more maintainable code.

  _Because nothing says 'productivity' like turning your prompts into Python functions so you can debug them with type hints._

  `langchain` `prompt-engineering` `python` `decorators` `syntactic-sugar`
  </details>

- **[ForeverVM](https://github.com/jamsocket/forevervm)** `⭐ 227` `updated >1y` A hosted API and CLI for running arbitrary, stateful Python code in secure, persistent sandboxes. <details><summary>More about</summary>

  Developers can offload long-running or stateful Python tasks to isolated environments without managing infrastructure.

  _Now you can spin up infinite REPLs that live forever, because nothing says 'production' like a Python process you forgot to kill._

  `sandbox` `python` `stateful` `api` `cli`
  </details>

- **[bondai](https://github.com/krohling/bondai)** `⭐ 221` `updated >1y` BondAI is an open-source framework for building single and multi-agent AI systems with built-in memory/context management, error handling, and tool integrations. <details><summary>More about</summary>

  It lets developers quickly assemble agents with pre-built tools (search, file I/O, web queries) and focus on task logic rather than infrastructure.

  _Finally, a way to offload your agent’s existential dread about context windows to a library._

  `agent-framework` `multi-agent` `python` `cli` `open-source`
  </details>

- **[flox](https://github.com/flox-foundation/flox)** `⭐ 219` `updated ≤30d` An AI-native framework for building trading systems with polyglot bindings and an MCP control plane. <details><summary>More about</summary>
...
- **[mux-node-sdk](https://github.com/muxinc/mux-node-sdk)** `⭐ 180` `updated ≤30d` Official Node.js/TypeScript SDK and bundled MCP server for the Mux video platform, providing REST API access and AI assistant integrations for video streaming and analytics. <details><summary>More about</summary>
...
- **[swarms-rs](https://github.com/the-swarm-corporation/swarms-rs)** `⭐ 175` `updated ≤1y` swarms-rs is a Rust-based framework for building and orchestrating multi-agent systems, designed to handle concurrent agent communication and collaboration with a focus on performance and memory safety. <details><summary>More about</summary>
...
- **[Axar](https://github.com/axar-ai/axar)** `⭐ 162` `updated ≤180d` A lightweight TypeScript framework for building production-ready agentic applications with explicit control and minimal abstractions. <details><summary>More about</summary>

  It lets developers build reliable LLM-powered apps using familiar TypeScript patterns, avoiding the complexity of many agent frameworks.

  _Finally, an agent framework that doesn’t treat your codebase like a black box of magic._
...
- **[kom](https://github.com/weibaohui/kom)** `⭐ 150` `updated ≤180d` kom is a Go SDK wrapper for Kubernetes operations that provides kubectl-like functionality with CRD support, SQL querying, and MCP server capabilities. <details><summary>More about</summary>
...
- **[GenoMAS](https://github.com/liu-hy/genomas)** `⭐ 136` `updated ≤180d` A minimalist multi-agent framework for robust automation of scientific analysis workflows, such as gene expression analysis. <details><summary>More about</summary>
...
- **[Lux](https://github.com/spectral-finance/lux)** `⭐ 130` `updated ≤1y` Lux is an open-source, language-agnostic framework for building multi-agent systems using concepts like Agents, Signals, Prisms, Beams, and Lenses to orchestrate AI-driven workflows. <details><summary>More about</summary>
...
- **[wxflows](https://github.com/ibm/wxflows)** `⭐ 117` `updated ≤1y` Examples and tutorials for building AI applications with IBM's watsonx.ai Flows Engine, a tool for creating and deploying agent tools. <details><summary>More about</summary>
...
- **[Neurolink](https://github.com/juspay/neurolink)** `⭐ 112` `updated ≤30d` A TypeScript SDK and platform that unifies 24+ LLM providers, MCP servers, voice, RAG, and memory under a single interface for production AI integrations. <details><summary>More about</summary>
...
- **[swarm_ex](https://github.com/nrrso/swarm_ex)** `⭐ 88` `updated >1y` An Elixir library for lightweight AI agent orchestration inspired by OpenAI's Swarm. <details><summary>More about</summary>

  It brings the multi-agent orchestration patterns found in Python-centric ecosystems to the highly concurrent and fault-tolerant Elixir/Erlang runtime.

  _Another way to manage a swarm of agents, now with the added complexity of supervising them with Elixir processes._

  `elixir` `agent-orchestration` `multi-agent` `concurrency` `orchestration`
  </details>
...
- **[ai-orchestra](https://github.com/langtail/ai-orchestra)** `⭐ 84` `updated >1y` AI Orchestra is a lightweight TypeScript library for orchestrating AI agents with state transitions and handoffs using Vercel's streamText. <details><summary>More about</summary>

  It lets developers coordinate multiple AI agents with explicit control over workflows and streaming, offering a simpler alternative to LangGraph or Swarm.

  _Yet another agent orchestration library promising to reduce complexity while adding yet another dependency to your AI stack._

  `agent-orchestration` `typescript` `streaming` `vercel-ai-sdk`
  </details>
...
- **[pdfmux](https://github.com/nameetp/pdfmux)** `⭐ 77` `updated ≤30d` A self-healing PDF extraction CLI and Python library that routes pages through multiple backends and audits output quality, with optional LLM fallbacks and an MCP server for Claude Desktop. <details><summary>More about</summary>
...
- **[qwed-verification](https://github.com/qwed-ai/qwed-verification)** `⭐ 57` `updated ≤30d` An open-source Python framework that uses symbolic verification, math, and logic to deterministically verify LLM outputs, SQL, and tool calls before they execute in production. <details><summary>More about</summary>
...
- **[coingecko-typescript](https://github.com/coingecko/coingecko-typescript)** `⭐ 55` `updated ≤30d` A TypeScript library for accessing the CoinGecko REST API with optional MCP server integration for AI assistants. <details><summary>More about</summary>
...
- **[Intelli](https://github.com/intelligentnode/intelli)** `⭐ 55` `updated ≤30d` A Python framework for building multi-model chatbots and agent workflows with support for MCP and various AI providers. <details><summary>More about</summary>

  Developers can create and orchestrate AI agents across different models (OpenAI, Claude, Mistral, etc.) with a unified interface, including MCP integration for standardized interactions.

  _Finally, a way to make your agents argue with each other across five different model providers before settling on a single answer._

  `agent-framework` `multi-model` `mcp` `workflow-orchestration` `python`
  </details>

- **[a2a-net](https://github.com/neuroglia-io/a2a-net)** `⭐ 54` `updated ≤180d` A .NET SDK and framework implementing the Agent-to-Agent (A2A) protocol to enable JSON-RPC based communication, discovery, and task orchestration between autonomous agents across different frameworks. <details><summary>More about</summary>
...
- **[subagents-pydantic-ai](https://github.com/vstorm-co/subagents-pydantic-ai)** `⭐ 54` `updated ≤30d` Subagent delegation library for Pydantic AI that enables nested, dynamically spawned specialist agents with sync/async/auto execution modes and runtime agent creation. <details><summary>More about</summary>
...
- **[Langchain-hs](https://github.com/tusharad/langchain-hs)** `⭐ 52` `updated ≤30d` Haskell implementation of the LangChain framework for building LLM-powered applications. <details><summary>More about</summary>
...
- **[futuresearch-python](https://github.com/futuresearch/futuresearch-python)** `⭐ 47` `updated ≤30d` A Python SDK and MCP toolkit designed to deploy specialized multi-agent teams for forecasting, research, and data classification tasks. <details><summary>More about</summary>
...
- **[Tiny-GraphRAG](https://github.com/limafang/tiny-graphrag)** `⭐ 44` `updated >1y` A minimal, educational Python implementation of GraphRAG that builds local knowledge graphs in Neo4j and supports local and global queries. <details><summary>More about</summary>
...
- **[agent-swarm-kit](https://github.com/tripolskypetr/agent-swarm-kit)** `⭐ 38` `updated ≤30d` A TypeScript npm library for building orchestrated, framework-agnostic multi-agent AI systems with session management, agent testing utilities, and MCP server connectivity. <details><summary>More about</summary>
...
- **[mdma](https://github.com/mobilereality/mdma)** `⭐ 38` `updated ≤30d` MDMA extends Markdown with interactive components like forms, approval gates, and webhooks so LLMs can generate actionable, schema-driven documents instead of plain text. <details><summary>More about</summary>
...
- **[shifts](https://github.com/aaronrussell/shifts)** `⭐ 36` `updated >1y` An Elixir framework for composing autonomous AI agent workflows using various LLM backends. <details><summary>More about</summary>

  It allows Elixir developers to build complex, multi-model agentic workflows using familiar piping and functional patterns.

  _Just what your Elixir codebase needed: another layer of non-deterministic concurrency to debug._

  `elixir` `agent-orchestration` `workflows` `llm` `automation`
  </details>

- **[s2-sdk-typescript](https://github.com/s2-streamstore/s2-sdk-typescript)** `⭐ 33` `updated ≤30d` Official TypeScript SDK for S2, a managed serverless service providing durable, real-time append-only streams with random read access. <details><summary>More about</summary>
...
- **[a2a-langgraph](https://github.com/mifune-dev/a2a-langgraph)** `⭐ 31` `updated >1y` A sample implementation that exposes a LangGraph ReAct agent as a server compliant with Google's Agent-to-Agent (A2A) protocol for multi-turn, streaming currency conversion. <details><summary>More about</summary>
...
- **[CoreAgent](https://github.com/coreagent-project/coreagent)** `⭐ 28` `updated >1y` CoreAgent is a lightweight Python framework for building LLM agents with shared stateful tools. <details><summary>More about</summary>

  It lets developers quickly integrate language models with custom, reusable tools that maintain state across agent interactions.

  _Finally, a framework that lets your agents share state—because nothing says 'intelligent' like two agents arguing over who incremented the counter last._

  `agent-framework` `python` `stateful-tools` `llm-integration`
  </details>

- **[AgentOS](https://github.com/the-swarm-corporation/agentos)** `⭐ 25` `updated >1y` AgentOS is a single-file, SDK-based Python implementation of Karpathy's Agent OS architecture that provides a unified interface for multiple LLMs, browser automation, and multimodal tooling to build autonomous agents. <details><summary>More about</summary>
...
- **[agoragentic-integrations](https://github.com/rhein1/agoragentic-integrations)** `⭐ 23` `updated ≤30d` SDKs, MCP tooling, and protocol adapters for Agoragentic Agent OS, enabling deployed agents to route paid tasks, manage context via Micro ECF, and settle USDC transactions on Base L2. <details><summary>More about</summary>
...
- **[SwiftSwarm](https://github.com/jamesrochabrun/swiftswarm)** `⭐ 23` `updated >1y` Swift framework for lightweight multi-agent orchestration inspired by OpenAI's Swarm library. <details><summary>More about</summary>

  Provides Swift engineers with a code-first way to experiment with agent coordination and handoffs in their apps.

  _Finally, a way to turn your iOS app into a swarm of stateless agents arguing over Chat Completions API calls._

  `swift` `multi-agent` `orchestration` `framework`
  </details>

- **[t2000](https://github.com/mission69b/t2000)** `⭐ 22` `updated ≤30d` t2000 is a TypeScript SDK, CLI, and MCP server providing agentic infrastructure for building conversational finance applications on the Sui blockchain. <details><summary>More about</summary>
...
- **[swarm-ai](https://github.com/intelliswarm-ai/swarm-ai)** `⭐ 21` `updated ≤30d` A Java-based multi-agent orchestration framework built on Spring AI that enables dynamic skill generation, runtime capability detection, and enterprise-grade governance for agent workflows. <details><summary>More about</summary>

  It gives JVM teams an opinionated agent layer with built-in budget enforcement, RBAC, and approval gates for production-grade multi-agent systems.

  _Finally, a way to make Java developers feel like they’re in a sci-fi swarm intelligence movie while debugging Spring Boot configs._

  `java` `multi-agent` `spring-ai` `enterprise` `orchestration`
  </details>

- **[a2a4j](https://github.com/pheonixhkbxoic/a2a4j)** `⭐ 18` `updated >1y` A Java SDK and Spring Boot scaffold implementing Google's Agent-to-Agent (A2A) protocol for building interoperable, multi-vendor AI agents. <details><summary>More about</summary>
...
- **[alaya](https://github.com/securityronin/alaya)** `⭐ 14` `updated ≤30d` Alaya is an embeddable Rust memory engine for conversational AI agents that applies neuroscience-grounded memory dynamics—such as dual-strength forgetting, retrieval-induced suppression, and Hebbian co-activation—to store, retrieve, and decay agent memories using a single SQLite file. <details><summary>More about</summary>
...
- **[Flux0](https://github.com/flux0-ai/flux0)** `⭐ 13` `updated ≤1y` Flux0 is a framework for deploying and orchestrating AI agents with real-time streaming, session management, and LLM-agnostic integration. <details><summary>More about</summary>
  ...
  _Another framework promising to solve the 'complexity of AI apps' while adding yet another layer of abstraction to learn._

  `agent-framework` `real-time` `multi-agent`
  </details>

- **[ruby-openai-swarm](https://github.com/graysonchen/ruby-openai-swarm)** `⭐ 11` `updated >1y` A Ruby-based framework adapted from OpenAI’s Swarm for lightweight multi-agent orchestration. <details><summary>More about</summary>

  It brings OpenAI’s Swarm handoff and routines patterns to Ruby developers, offering an ergonomic way to coordinate multiple agents in code.

  _Now you can orchestrate agents in Ruby while wondering if you’re just reinventing the wheel in a language that’s already a wheel._
...
- **[swarm-go](https://github.com/feiskyer/swarm-go)** `⭐ 8` `updated >1y` A lightweight multi-agent orchestration framework for Go, inspired by OpenAI's Swarm. <details><summary>More about</summary>

  It allows Go developers to build complex, event-driven multi-agent systems and handoff workflows using native Go function calls.

  _Because apparently, the only thing missing from the Go ecosystem was a way to implement OpenAI's specific architectural patterns in typed code._

  `go` `multi-agent` `orchestration` `agentic-workflows`
  </details>

- **[discovery-engine](https://github.com/leap-laboratories/discovery-engine)** `⭐ 7` `updated ≤30d` Discovery Engine is a statistical pattern-finding tool that identifies validated, novel feature interactions in tabular data using ML and literature checks. <details><summary>More about</summary>

  It helps developers and data scientists uncover hidden, hypothesis-free patterns in data that standard analysis or LLMs would miss.
...
- **[edict](https://github.com/sowiedu/edict)** `⭐ 7` `updated ≤30d` A programming language purpose-built for AI agents where programs are JSON ASTs, validated by a type/effect system and Z3 contracts, then compiled to WASM via an MCP server interface. <details><summary>More about</summary>
...
- **[aegis-dq](https://github.com/aegis-dq/aegis-dq)** `⭐ 4` `updated ≤90d` An agentic framework that uses LLMs to generate data quality rules from policy documents, validate data, and propose SQL remediations. <details><summary>More about</summary>
...
- **[agenium](https://github.com/aganium/agenium)** `⭐ 4` `updated ≤180d` An agent-to-agent communication protocol providing identity, discovery, and secure messaging via the `agent://` URI scheme. <details><summary>More about</summary>
...
- **[Agently](https://github.com/maplemx/agently)** `⭐ 4` `updated ≤30d` Agently is a GenAI application development framework for building and managing AI agents with structured output, event-driven workflows, and model-agnostic configuration. <details><summary>More about</summary>
  ...
  _Yet another framework promising to solve the 'why won’t my JSON parse?' problem while adding its own layer of YAML-adjacent syntax to learn._

  `ai-framework` `agent-workflow` `model-agnostic`
  </details>
...
- **[waveguardclient](https://github.com/gpartin/waveguardclient)** `⭐ 4` `updated ≤180d` Python SDK for WaveGuard, a physics-based anomaly detection API that works on any data type with a single stateless call. <details><summary>More about</summary>

  Developers can integrate GPU-accelerated anomaly detection into their workflows without ML expertise or training pipelines.

  _Finally, an API that detects anomalies in your data by simulating wave physics, because why should machine learning have all the fun?_

  `anomaly-detection` `sdk` `gpu` `mcp-server` `python`
  </details>

- **[revettr-python](https://github.com/alexanderlawson17/revettr-python)** `⭐ 3` `updated ≤180d` Python client SDK for Revettr's counterparty risk scoring API, designed for AI agents transacting via x402 on Base. <details><summary>More about</summary>

  Enables developers to programmatically assess counterparty risk (domain, IP, wallet, sanctions) before agentic transactions, reducing fraud exposure in autonomous workflows.
...
- **[cosmergon-agent](https://github.com/rkocosmergon/cosmergon-agent)** `⭐ 2` `updated ≤30d` A Python SDK and MCP server for deploying and managing autonomous AI agents that participate in a tick-based Conway's Game of Life economy with energy currency and marketplace trading. <details><summary>More about</summary>
...
- **[echolon](https://github.com/dolphinquant/echolon)** `⭐ 2` `updated ≤30d` An LLM-agent-native backtest framework designed for conducting quantitative futures research. <details><summary>More about</summary>
...
- **[agent-toolbelt](https://github.com/marras0914/agent-toolbelt)** `⭐ 1` `updated ≤30d` A collection of stock research and utility tools for AI agents, accessible via a production API and npm SDK. <details><summary>More about</summary>

  It allows developers to quickly equip agents with specialized financial knowledge and common data-processing capabilities without building custom tool integrations from scratch.

  _Because nothing says 'robust agentic workflow' like delegating your entire investment strategy to a series of $0.05 API calls._

  `agent-tools` `finance-ai` `sdk` `langchain` `api`
  </details>
...
- **[systemr-python](https://github.com/system-r-ai/systemr-python)** `⭐ 1` `updated ≤180d` A Python SDK for agents.systemr.ai providing 55 MCP-compatible tools and 25 broker integrations for building AI-driven trading agents with institutional-grade risk management. <details><summary>More about</summary>
...
- **[yieldagentx402-sdks](https://github.com/fabio662/yieldagentx402-sdks)** `⭐ 1` `updated ≤90d` A collection of SDKs and integration tools for the YieldAgentX402 platform, enabling secure, policy-gated financial execution for AI agents across 18 blockchain networks. <details><summary>More about</summary>
...
- **[Agent Cost Guardrails](https://github.com/sapph1re/agent-cost-guardrails)** `⭐ 0` `updated ≤30d` A pure Python middleware library that enforces hard budget limits, rate limits, and circuit breakers for AI agent frameworks including CrewAI, AutoGen, and LangGraph. <details><summary>More about</summary>
...
- **[AutoGen Documentation](https://microsoft.github.io/autogen)** An open-source framework for developing and orchestrating multi-agent systems using conversational patterns. <details><summary>More about</summary>

  It enables developers to build complex, autonomous workflows by coordinating multiple specialized AI agents that can talk to each other.

  _You'll spend more time debugging agent conversational loops than actually writing the logic they are supposed to implement._

  `multi-agent` `orchestration` `agents` `automation`
  </details>
...
- **[Code Interpreter SDK](https://e2b.dev/docs)** E2B provides secure, isolated sandboxes for AI agents to execute code and interact with real-world tools. <details><summary>More about</summary>

  It solves the critical security and infrastructure challenge of allowing autonomous agents to run untrusted code in a controlled, ephemeral environment.

  _Because trusting an LLM with a shell is a recipe for disaster, you now need a dedicated infrastructure layer just to contain the chaos._

  `sandboxing` `code-interpreting` `agent-infrastructure` `security`
  </details>
...
- **[Langchain Data Analyst](https://docs.langchain.com/oss/python/integrations/providers/overview)** A Python library providing standardized interfaces to integrate with diverse LLM providers, tools, and vector stores. <details><summary>More about</summary>

  It enables developers to build AI applications with a consistent API, making it easy to swap underlying models or databases without rewriting core logic.

  _It provides the ultimate abstraction layer that helps you confidently swap one slightly-different-but-mostly-the-same LLM for another._

  `llm-abstraction` `python-sdk` `agent-framework` `integrations`
  </details>

- **[LangGraph Documentation](https://docs.langchain.com/oss/python/langgraph/overview)** LangGraph is a library for building stateful, multi-agent applications with cycles using LangChain. <details><summary>More about</summary>

  It provides the necessary orchestration primitives to move beyond simple chains into complex, iterative agentic workflows.

  _Your architecture will eventually just be a massive, undecipherable directed acyclic graph (or cyclic graph) of state transitions._

  `agent-orchestration` `multi-agent` `stateful-workflows` `langchain`
  </details>
...
- **[Open Responses](https://docs.julep.ai/open-responses)** Open-responses is a serving framework for managing and scaling AI agent responses. <details><summary>More about</summary>

  It provides the infrastructure needed to move from simple chat prompts to managed, scalable agent-based application responses.

  _Just one more layer of abstraction to manage before you can finally ship that unreliable agentic workflow._

  `agent-serving` `llmops` `agent-infrastructure`
  </details>
...
- **[Rivestack](https://rivestack.io)** Managed PostgreSQL with optimized pgvector on dedicated NVMe storage for AI workloads, offering low-latency vector search and built-in semantic search tools. <details><summary>More about</summary>
  ...
  Developers can consolidate vector and relational data in a single database with predictable pricing and high-performance vector search, avoiding the complexity of separate vector DBs or cold-start issues.

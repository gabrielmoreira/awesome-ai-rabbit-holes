...
- **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code)** `⭐ 78.4k` `updated ≤30d` An AI-powered tool that converts screenshots, mockups, and screen recordings into functional code in various web stacks. <details><summary>More about</summary>
...
- **[dyad](https://github.com/dyad-sh/dyad)** `⭐ 21.3k` `updated ≤30d` Local, open-source AI app builder for creating applications with various AI models on your own machine. <details><summary>More about</summary>

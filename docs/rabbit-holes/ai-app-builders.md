...
- **[dyad](https://github.com/dyad-sh/dyad)** `⭐ 21.2k` `updated ≤30d` Local, open-source AI app builder for creating applications with various AI models on your own machine. <details><summary>More about</summary>

...
export function loadSettingsFromRaw(
  ...
  const promotion = { ...DEFAULTS.promotion, ...asMapping(fileRoot.promotion, "settings.promotion"), ...asObject(overrides.promotion) };
  const github = { ...DEFAULTS.github, ...asMapping(fileRoot.github, "settings.github"), ...asObject(overrides.github) };
  const budgetsRaw = { ...DEFAULTS.budgets, ...asMapping(fileRoot.budgets, "settings.budgets"), ...asObject(overrides.budgets) };
  const concurrencyRaw = { ...DEFAULTS.concurrency, ...asMapping(fileRoot.concurrency, "settings.concurrency"), ...asObject(overrides.concurrency) };
